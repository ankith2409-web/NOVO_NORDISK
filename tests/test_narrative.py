"""AI summaries over drift reports: opt-in, evidence-only, non-fatal.
...
never requested unless asked for, so drift keeps working with no LLM key
configured at all. And a failed summary degrades to an explained absence,
